...
class Productxpart(Base):
    ...
    id_supplier = Column(String(length=100),ForeignKey('supplier.id'), nullable=False, unique=True)
    id_branch = Column(String(length=100),ForeignKey('branch.id'), nullable=True )
